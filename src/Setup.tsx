...
import {fetchItem, fetchRecommended} from "./server/api";
...
const routes = {
    '/product/:id': function* usersSaga(b: {id: number}) {
        ...
        const initalProductPageState: IProductPage = {featuredProduct: loading, recommendedProducts: loading}
        ...
        const featuredProduct: WebData<Product> = yield call(fetchItem, b.id)
